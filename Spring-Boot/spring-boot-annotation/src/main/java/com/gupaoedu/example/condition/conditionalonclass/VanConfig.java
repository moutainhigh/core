...
//    @ConditionalOnClass(Billy.class) // 这种方式使用跟下面name使用是一模一样
  @ConditionalOnClass(name = "com.gupaoedu.example.condition.conditionalonclass.Billy")

//    @ConditionalOnClass(name = "com.gupaoedu.example.condition.conditionalonclass.Billy99")
    public Billy billy() {
